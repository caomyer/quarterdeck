...
`tests/fm-home-init.test.sh` (4000) and `tests/fm-installed-home.test.sh` (15000) are likewise rounded up from local macOS runs of 2146ms and 8973ms on 2026-09-19; refresh them from the next green run.
